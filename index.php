    ...
    <script>
        const userStoriesHTML = `
            ...
            <div class="cards-grid">
                ...
                <!-- Ortiz  Nicole -->
                <div class="card card-user-story"><div class="card-header">Ortiz Nicole1</div><div class="card-body"><p><span class="keyword">Como</span> visitante,</p><p><span class="keyword">Quiero</span> filtrar productos por precio,</p><p><span class="keyword">Para</span> encontrar opciones dentro de mi presupuesto.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Ortiz Nicole2</div><div class="card-body"><p><span class="keyword">Como</span> cliente,</p><p><span class="keyword">Quiero</span> recibir recomendaciones personalizadas,</p><p><span class="keyword">Para</span> descubrir productos de mi interés.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Ortiz Nicole3</div><div class="card-body"><p><span class="keyword">Como</span> usuario,</p><p><span class="keyword">Quiero</span> ver las reseñas de otros usuarios,</p><p><span class="keyword">Para</span> tomar decisiones informadas antes de comprar.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Ortiz Nicole4</div><div class="card-body"><p><span class="keyword">Como</span> visitante,</p><p><span class="keyword">Quiero</span> registrarme rápidamente,</p><p><span class="keyword">Para</span> poder hacer compras sin complicaciones.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Ortiz Nicole5</div><div class="card-body"><p><span class="keyword">Como</span> estudiante,</p><p><span class="keyword">Quiero</span> acceder al historial académico,</p><p><span class="keyword">Para</span> comparar mi desempeño con mis compras.</p></div></div>
                <!-- Britney Garcia -->
                <div class="card card-user-story"><div class="card-header">Britney Garcia</div><div class="card-body"><p><span class="keyword">Como</span> usuaria,</p><p><span class="keyword">Quiero</span> tener un chat de soporte en línea,</p><p><span class="keyword">Para</span> resolver dudas rápidamente.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Britney Garcia</div><div class="card-body"><p><span class="keyword">Como</span> cliente,</p><p><span class="keyword">Quiero</span> guardar mis productos favoritos,</p><p><span class="keyword">Para</span> comprarlos más tarde fácilmente.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Britney Garcia</div><div class="card-body"><p><span class="keyword">Como</span> usuaria,</p><p><span class="keyword">Quiero</span> recibir alertas de disponibilidad,</p><p><span class="keyword">Para</span> no perder ofertas limitadas.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Britney Garcia</div><div class="card-body"><p><span class="keyword">Como</span> desarrolladora,</p><p><span class="keyword">Quiero</span> integrar un sistema de pagos seguro,</p><p><span class="keyword">Para</span> proteger los datos de los clientes.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Britney Garcia</div><div class="card-body"><p><span class="keyword">Como</span> administrador,</p><p><span class="keyword">Quiero</span> generar reportes de errores del sistema,</p><p><span class="keyword">Para</span> mejorar la plataforma continuamente.</p></div></div>
                 <!-- Emely Jiron -->
                <div class="card card-user-story"><div class="card-header">Emely Jiron</div><div class="card-body"><p><span class="keyword">Como</span> cliente,</p><p><span class="keyword">Quiero</span> recibir confirmaciones de envío,</p><p><span class="keyword">Para</span> seguir mi pedido en tiempo real.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Emely Jiron</div><div class="card-body"><p><span class="keyword">Como</span> usuario,</p><p><span class="keyword">Quiero</span> filtrar productos por popularidad,</p><p><span class="keyword">Para</span> ver los más comprados.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Emely Jiron</div><div class="card-body"><p><span class="keyword">Como</span> visitante,</p><p><span class="keyword">Quiero</span> ver ofertas del día,</p><p><span class="keyword">Para</span> aprovechar descuentos rápidos.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Emely Jiron</div><div class="card-body"><p><span class="keyword">Como</span> cliente,</p><p><span class="keyword">Quiero</span> recibir un historial de mis reseñas,</p><p><span class="keyword">Para</span> tener control de mi actividad.</p></div></div>
                <div class="card card-user-story"><div class="card-header">Emely Jiron</div><div class="card-body"><p><span class="keyword">Como</span> visitante,</p><p><span class="keyword">Quiero</span> ver ofertas del día,</p><p><span class="keyword">Para</span> aprovechar descuentos rápidos.</p></div></div>
            </div>
        `;
